...
/**
 * A class for testing the quad probe hash table. 
 * 
...
public class QuadProbeHashTableTest {
	QuadProbeHashTable tester = new QuadProbeHashTable(100, new BadHash());
	...
	/**
	 * This test ensures false is returned when contains is called on an empty list. 
	 * 
	 */
	@Test
