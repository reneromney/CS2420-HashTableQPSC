...
/**
 * A class for timing the chaining hash table. 
 * 
...
public class ChainingTiming {
	...
	public static void main(String[] args) {
		...
		for (int n = 1000; n <= 20000; n += 1000) {
			System.out.print(n + "\t");
			//Makes array of chaining hash tables.
			ChainingHashTable d[] = new ChainingHashTable[timesToLoop];
			for(int i = 0; i < timesToLoop; i++){
				ChainingHashTable qH = new ChainingHashTable(n,new GoodHash());
 ...
 */
	private static void generateStrings(int n, ChainingHashTable ht, int seed) {
		//final int SEED = 300;
